...
export class LangService {
  ...
  private getDefaultLangIndex(): ILangObject {
    return this.langsData[this.DEFAULT_LANGUAGE_INDEX];
  }

  getLanguagesCollection(): ILangObject[] {
    return this.langsData;
  }

  getLanguageByIndex(index: number): ILangObject {
    return this.langsData[index];
  }
